...
//
//float* meshToGPU_thrust(const std::vector<Eigen::Vector3i>& triPointsIdx,
//	const std::vector<Eigen::Vector3f>& modelPoints) {
...
//	// fill host vector
//	const size_t faces = triPointsIdx.size();
//	for (int i = 0; i < faces; ++i)
//	{
//		h_triangleThrustVec->push_back(modelPoints[triPointsIdx[i].x()]);
//		h_triangleThrustVec->push_back(modelPoints[triPointsIdx[i].y()]);
//		h_triangleThrustVec->push_back(modelPoints[triPointsIdx[i].z()]);
//	}
//	*d_triangleThrustVec = *h_triangleThrustVec;
