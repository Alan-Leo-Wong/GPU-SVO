...
namespace libmorton {
	...
	// ENCODING
#if defined(__BMI2__) || defined(__AVX2__)
	inline CUDA_CALLABLE_MEMBER uint_fast32_t morton2D_32_encode(const uint_fast16_t x, const uint_fast16_t y) {
		return m2D_e_BMI<uint_fast32_t, uint_fast16_t>(x, y);
	}
	inline CUDA_CALLABLE_MEMBER uint_fast64_t morton2D_64_encode(const uint_fast32_t x, const uint_fast32_t y) {
		return m2D_e_BMI<uint_fast64_t, uint_fast32_t>(x, y);
	}
	inline CUDA_CALLABLE_MEMBER uint_fast32_t morton3D_32_encode(const uint_fast16_t x, const uint_fast16_t y, const uint_fast16_t z) {
		return m3D_e_BMI<uint_fast32_t, uint_fast16_t>(x, y, z);
	}
	inline CUDA_CALLABLE_MEMBER uint_fast64_t morton3D_64_encode(const uint_fast32_t x, const uint_fast32_t y, const uint_fast32_t z) {
...
#if defined(__BMI2__) || defined(__AVX2__)
	inline CUDA_CALLABLE_MEMBER void morton2D_32_decode(const uint_fast32_t morton, uint_fast16_t& x, uint_fast16_t& y) {
		m2D_d_BMI<uint_fast32_t, uint_fast16_t>(morton, x, y);
	}
	inline CUDA_CALLABLE_MEMBER void morton2D_64_decode(const uint_fast64_t morton, uint_fast32_t& x, uint_fast32_t& y) {
		m2D_d_BMI<uint_fast64_t, uint_fast32_t>(morton, x, y);
	}
	inline CUDA_CALLABLE_MEMBER void morton3D_32_decode(const uint_fast32_t morton, uint_fast16_t& x, uint_fast16_t& y, uint_fast16_t& z) {
		m3D_d_BMI<uint_fast32_t, uint_fast16_t>(morton, x, y, z);
	}
	inline CUDA_CALLABLE_MEMBER void morton3D_64_decode(const uint_fast64_t morton, uint_fast32_t& x, uint_fast32_t& y, uint_fast32_t& z) {
