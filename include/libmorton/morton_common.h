...
namespace libmorton {
	...
	inline CUDA_CALLABLE_MEMBER bool findFirstSetBitZeroIdx(const morton x, unsigned long* firstbit_location) {
	...
	template<typename morton>
	inline CUDA_CALLABLE_MEMBER bool findFirstSetBit(const morton x, unsigned long* firstbit_location) {
